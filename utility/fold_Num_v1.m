function [ CTfeatureT, MRIfeatureT ] = fold_Num_v1(currentFolder, subject1, subject2, LOADALPHA)
%fold_Num_v1: aims to generate the feature of subject1 and subject2 in the
...
indexSubjectTotal = [1:4, 6:8, 10, 12, 13];  % indexSubject does not seem to have a regular pattern. This is to follow the style of original dataset from hospital. 
...
[dataTestCT, dataTestMRI] = preProcess(dirTest, indexSubjectTotal(subject1));
...
[dataTestCT, dataTestMRI] = preProcess(dirTest, indexSubjectTotal(subject2));
dataTestCT  = double(dataTestCT )/65535;
dataTestMRI = double(dataTestMRI)/65535;
for imageNo = 1:60
    disp(['processing imageNo.' num2str(imageNo)]);
